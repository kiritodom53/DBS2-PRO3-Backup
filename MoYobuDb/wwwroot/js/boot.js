...
//     $.getJSON('https://moyobudb.conveyor.cloud/API/GET/ANIME/FIND?page=4', function(data) {
//         var anime = data;
//         for (i = 0; i < anime.length; i++) {
//             //$('#test').append('<p>' + anime.animes[i].romajiTitle + '</p>');
//             $('#test').append('<p>' + anime[i].romajiTitle + '</p>');
//         }
//     });
// }
...
filter.split(" ").join("+");
//$('#test').append(filter);
var path = 'https://localhost:5001/API/GET/ANIME/FIND?name='+filter;
    $.getJSON(path, function(data) {
        var anime = data;
       
        for (i = 0; i < anime.length; i++) {  
                $('#myDropdown').append("<a href=\"something\" class=\"hover\">"+ anime[i].romajiTitle+ "</a>");
...
//       //a[i].style.display = "";
//         $('#myDropdown').append("<a href=\"something\" class=\"hover\">"+ anime.animes[i].romajiTitle+ "</a>");
//         pocet++;
//     } else {
...
//        $('#test').append('<p>' + $('#searchBox').textInput.value + '</p>');
